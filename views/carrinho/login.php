        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 mt-4 mt-md-0">
                ...
                <form name="formLogin" method="post" action="carrinho/logar" data-parsley-validate>
                    ...
                    <button type="submit" class="btn btn-dark mt-2 border-0 rounded-4">Efetuar Login</button>
                </form>
            </div>
            ...
            <div class="col-12 col-md-6 mt-4 mt-md-0">
                ...
                <form name="formCadastro" method="post" action="carrinho/cadastrar" data-parsley-validate>
                    ...
                    <button type="submit" class="btn btn-dark mt-2 border-0 rounded-4">Efetuar Cadastro</button>
                </form>
            </div>
