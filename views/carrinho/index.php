...
<div class="card">
    ...
    <div class="card-body">
        <?php if (isset($_SESSION["cliente"]["id"])) {
            echo "<p class='alert alert-success text-center p-2 m-2'> Olá {$_SESSION['cliente']['nome']} - <a href='carrinho/sair'>Sair</a> </p> <br>";
        } ?>
        ...
        <div class="btn-group gap-3">
            ...
            <a href="#" class="btn btn-dark border-0 rounded-4" id="finalizar-compra"> Finalizar Compra </a>
        </div>
